...
/** Sections of Settings that arrive after the screen itself, with their stage (design doc §15). */
const SITES = { stage: 2, built: true };
...
export default function SettingsPage() {
  ...
  return (
    <div data-screen-label="Settings" className="flex w-full max-w-[900px] flex-col gap-4 px-5 pb-8 pt-3">
      ...
      {isVisible(SITES, showUpcoming) && <Sites canEdit={canChangeSettings(me.job_title)} actor={signOffName(me)} />}
