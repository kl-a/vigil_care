...
import { JOB_TITLE_LABEL, canChangeSettings, canSwitchModules } from "@/lib/jobTitles";
...
export default function SettingsPage() {
  ...
  return (
    <div data-screen-label="Settings" className="flex w-full max-w-[900px] flex-col gap-4 px-5 pb-8 pt-3">
      ...
      <SpecialtyModules canSwitch={canSwitchModules(me.job_title)} actor={`${me.display_name} (${JOB_TITLE_LABEL[me.job_title]})`} />
    </div>
  );
}
